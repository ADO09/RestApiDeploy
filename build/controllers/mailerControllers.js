        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield mailer_1.transporter.sendMail({
                    from: '"Fred Foo 👻" <fisioliness@gmail.com>',
                    to: "Jesusroberto.hijarangulo.01@gmail.com,antonio.audeves17@gmail.com",
                    subject: "IRA PINCHE CAT ✔",
                    text: "Tu candado ya bailo",
                    html: `
            <h2> HOLA</>
            `, // html body
                });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield mailer_1.transporter.sendMail({
                    ...
                    text: "Tu cita a sido aceptada revisa la pagina porfavor",
                    html: `
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield mailer_1.transporter.sendMail({
                    ...
                    to: correoDes,
                    subject: "Cita aceptada ✔",
                    text: "Tus cambios de cita an sido aceptados revisa la pagina porfavor",
                    html: `
              <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
              <html xmlns="http://www.w3.org/1999/xhtml">
                <head>
