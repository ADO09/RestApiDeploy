...
import { inisesion } from "../interfaces/generalInterface";
import {transporter} from './../config/mailer';

class GeneralController {
    //CLIENTES FISIOTERAPEUTAS
    public async inicioSesion(req: Request, res: Response): Promise<any> {
        try {
    ...
    public async forgotPassword(req: Request, res: Response): Promise<any> {
        ...
        try {
            await transporter.sendMail({
               ...
               text: 'Aqui esta tu contra burro', // plain text body
               html:  `
